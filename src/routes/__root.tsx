...
const DEFAULT_DESCRIPTION =
  "Domínio premium cassinodegramado.com.br à venda para turismo, resorts e entretenimento regulado em Gramado.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cassino de Gramado à Venda | cassinodegramado.com.br" },
      ...
      { property: "og:title", content: "Cassino de Gramado à Venda | cassinodegramado.com.br" },
      { property: "og:description", content: DEFAULT_DESCRIPTION },
      { property: "og:image", content: OG_IMAGE },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Cassino de Gramado à Venda | cassinodegramado.com.br" },
