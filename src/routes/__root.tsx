...
const DEFAULT_DESCRIPTION =
  "Domínios premium cassinodesaopaulo.com.br, cassinodesaopaulo.com e cassinosaopaulo.com à venda para turismo, resorts e entretenimento regulado em São Paulo.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cassino de São Paulo à Venda | cassinodesaopaulo.com.br" },
      ...
      { property: "og:title", content: "Cassino de São Paulo à Venda | cassinodesaopaulo.com.br" },
      { property: "og:description", content: DEFAULT_DESCRIPTION },
      { property: "og:image", content: OG_IMAGE },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Cassino de São Paulo à Venda | cassinodesaopaulo.com.br" },
