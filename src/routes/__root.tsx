...
const DEFAULT_DESCRIPTION =
  "Domínio premium cassinocopacabana.com à venda para turismo, resorts e entretenimento regulado em Copacabana, Rio de Janeiro.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cassino Copacabana à Venda | cassinocopacabana.com" },
      ...
      { property: "og:title", content: "Cassino Copacabana à Venda | cassinocopacabana.com" },
      { property: "og:description", content: DEFAULT_DESCRIPTION },
      { property: "og:image", content: OG_IMAGE },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Cassino Copacabana à Venda | cassinocopacabana.com" },
