...
const rawPosts: Omit<BlogPost, "date">[] = [
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Para jovens do Distrito Federal, a possibilidade de ingressar em programas de trainee em hotelaria e entretenimento regulado representa alternativa concreta à migração para grandes centros em busca de trabalho estável.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        heading: "MICE e o Distrito Federal",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Brasília não precisa competir com Las Vegas em escala; compete em exclusividade, clima e centro da capital federal. Entretenimento regulado moderado reforça posicionamento premium quando acompanhado de gastronomia, natureza e moderação — não de publicidade predatória.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "No Distrito Federal, áreas com vocação turística e boa conectividade permitem projetos de escala moderada — compatíveis com a paisagem urbana, infraestrutura e capacidade de saneamento — sem megaconstruções desalinhadas ao entorno.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Palavras-chave de cauda longa — cassino regulado Brasília, resort integrado Distrito Federal, emprego hotelaria — atraem público qualificado. Listas, FAQs e links internos entre artigos aumentam tempo de permanência e sinalizam profundidade editorial.",
