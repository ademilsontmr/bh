...
export const GOV_REFERENCES = {
  ...
  spGoverno: {
    label: "Governo do Estado do Rio de Janeiro",
    url: "https://www.rj.gov.br/",
    source: "Governo RJ",
  },
  spTurismo: {
    label: "Secretaria de Turismo do Estado do RJ",
    url: "https://www.turismo.rj.gov.br/",
    source: "Turismo RJ",
  },
...
export const BLOG_ARTICLE_EXTERNAL_REFS: Record<string, GovRefKey[]> = {
  ...
  "dominio-premium-seo-entretenimento-copacabana": ["turismo", "ibgeTurismo", "rioPrefeitura"],
  "tributacao-cassinos-regulados-financiamento-publico": ["receita", "coaf", "spaApostas"],
  "turismo-corporativo-copacabana-entretenimento": ["turismo", "ibgePnadTurismo", "rioPrefeitura"],
  "licoes-las-vegas-singapura-regulacao-brasil": ["senado", "camara", "senadoNoticiaCassinos"],
  "copacabana-polo-entretenimento-regulado": ["rioPrefeitura", "spTurismo", "senado"],
  "moderacao-jogo-responsavel-cassinos": ["jogoResponsavel", "saude", "leiApostas"],
  "resorts-integrados-rio-copacabana": ["turismo", "rioPrefeitura", "senado"],
  "cassinos-brasil-emprego-renda": ["senado", "trabalho", "ibgePnadTurismo"],
  "cassino-copacabana-potencial-economico": ["rioPrefeitura", "ibgeTurismo", "turismo"],
  ...
  "resorts-integrados-impacto-ambiental-copacabana": ["rioPrefeitura", "spGoverno", "turismo"],
  "marketing-digital-turismo-cassino-copacabana": ["turismo", "ibgeTurismo", "rioPrefeitura"],
  "cassinos-america-latina-comparativo-brasil": ["turismo", "senado", "camaraNoticiaJogos"],
  "hospedagem-luxo-entretenimento-regulado-copacabana": ["turismo", "rioPrefeitura", "ibgePnadTurismo"],
  "concessao-licitacao-cassino-municipio-brasil": ["rioPrefeitura", "senado", "camara"],
