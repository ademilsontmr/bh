...
export const GOV_REFERENCES = {
  ...
  camposPrefeitura: {
    label: "Prefeitura Municipal de Campos do Jordão",
    url: "https://www.campodojordao.sp.gov.br/",
    source: "Prefeitura de Campos do Jordão",
  },
  spGoverno: {
  ...
  spTurismo: {
    label: "Secretaria de Turismo e Viagens do Estado de SP",
...
export const BLOG_ARTICLE_EXTERNAL_REFS: Record<string, GovRefKey[]> = {
  ...
  "dominio-premium-seo-entretenimento-campos-jordao": ["turismo", "ibgeTurismo", "camposPrefeitura"],
  "tributacao-cassinos-regulados-financiamento-publico": ["receita", "coaf", "spaApostas"],
  "turismo-corporativo-campos-do-jordao-entretenimento": ["turismo", "ibgePnadTurismo", "camposPrefeitura"],
  "licoes-las-vegas-singapura-regulacao-brasil": ["senado", "camara", "senadoNoticiaCassinos"],
  "campos-do-jordao-polo-entretenimento-regulado": ["camposPrefeitura", "spTurismo", "senado"],
  "moderacao-jogo-responsavel-cassinos": ["jogoResponsavel", "saude", "leiApostas"],
  "resorts-integrados-serra-mantiqueira": ["turismo", "camposPrefeitura", "senado"],
  "cassinos-brasil-emprego-renda": ["senado", "trabalho", "ibgePnadTurismo"],
  "cassino-campos-do-jordao-potencial-economico": ["camposPrefeitura", "ibgeTurismo", "turismo"],
  ...
  "resorts-integrados-impacto-ambiental-campos-jordao": ["camposPrefeitura", "spGoverno", "turismo"],
  "marketing-digital-turismo-cassino-campos-jordao": ["turismo", "ibgeTurismo", "camposPrefeitura"],
  "cassinos-america-latina-comparativo-brasil": ["turismo", "senado", "camaraNoticiaJogos"],
  "hospedagem-luxo-entretenimento-regulado-serra": ["turismo", "camposPrefeitura", "ibgePnadTurismo"],
  "concessao-licitacao-cassino-municipio-brasil": ["camposPrefeitura", "senado", "camara"],
