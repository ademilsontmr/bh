...
export const BLOG_ENRICHMENTS: Record<string, SectionEnrichment[]> = {
  ...
  "turismo-corporativo-brasilia-entretenimento": [
    ...
    {
      listItems: [
        "Brasília compete em exclusividade e centro da capital federal — não em escala de [[Las Vegas|licoes-las-vegas-singapura-regulacao-brasil]]",
  ...
  "brasilia-polo-entretenimento-regulado": [
    {
      listItems: [
        "Menos de 2h de Brasília; hotéis boutique e gastronomia reconhecida",
